...
import { ArrowLeft, Cpu, Star, Zap, Download } from "lucide-react";
...
export default function ModulesPage() {
    ...
    const modules = activeApps.filter(app => app.category === 'System' || app.category === 'Utility');
                        ...
                        >
                            <div className="ios-squircle" style={{
                                ...
                                {isValidUrl(app.iconUrl) ? (
                                    ...
                                    <Cpu size={32} color="white" fill="white" />
                                )}
                            </div>
