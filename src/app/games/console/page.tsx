...
export default function ConsolePortalPage() {
    const consoleGames = appsData.filter(app => app.isGame && app.platforms?.includes('Android') && app.platforms?.includes('PS'));
    ...
    return (
        <div style={{
            ...
            <div style={{ marginBottom: '3rem', padding: '0 0.5rem' }}>
                ...
                <h1 style={{ fontSize: '2.5rem', fontWeight: '900', letterSpacing: '-1.5px', marginBottom: '0.6rem', color: 'white' }}>Console</h1>
                <p style={{ fontSize: '1rem', color: 'rgba(255,255,255,0.4)', fontWeight: '600', letterSpacing: '-0.2px' }}>Triple-A experiences in your hand.</p>
            </div>
                                ...
                                <div style={{ display: 'flex', gap: '0.4rem', alignItems: 'center' }}>
                                    {game.platforms?.includes('PS') && (
                                        <div className="glass" style={{ background: 'rgba(255,255,255,0.1)', padding: '0.3rem', borderRadius: '50%', border: '1px solid rgba(255,255,255,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                            <img src="/platforms/ps.png" alt="PS" style={{ width: '12px', height: '12px', filter: 'brightness(0) invert(1)' }} />
                                        </div>
                                    )}
                                    {game.platforms?.includes('Xbox') && (
                                        <div className="glass" style={{ background: 'rgba(255,255,255,0.1)', padding: '0.3rem', borderRadius: '50%', border: '1px solid rgba(255,255,255,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                            <img src="/platforms/xbox.png" alt="Xbox" style={{ width: '12px', height: '12px', filter: 'brightness(0) invert(1)' }} />
                                        </div>
                                    )}
                                </div>
            ...
            <div style={{
                ...
                width: '100vw',
                height: '100vh',
                background: 'radial-gradient(circle at 110% -10%, rgba(0, 122, 255, 0.08), transparent 50%), radial-gradient(circle at -10% 110%, rgba(88, 86, 214, 0.08), transparent 50%)',
                zIndex: -1,
                pointerEvents: 'none'
            }} />
        </div>
