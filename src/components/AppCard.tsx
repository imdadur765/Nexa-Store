            ...
            <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center', position: 'relative', zIndex: 1 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem', alignItems: 'flex-end', zIndex: 2 }}>
                    ...
                    <Link
                        ...
                        style={{ background: 'rgba(255,255,255,0.08)', color: 'var(--accent-primary)', fontSize: '0.7rem', padding: '0.25rem 0.85rem', border: 'none', borderRadius: '100px', fontWeight: '900', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', textDecoration: 'none' }}
                        onClick={(e) => {
                            e.stopPropagation();
                        }}
                    >
